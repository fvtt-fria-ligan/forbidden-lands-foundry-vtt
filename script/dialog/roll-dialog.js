...
export class RollDialog {
    ...
    static prepareRollDialog(rollName, baseDefault, skillDefault, gearDefault, artifactDefault, modifierDefault, damage, diceRoller, onAfterRoll) {
        ...
        let d = new Dialog({
            title: rollName !== "DICE.ROLL" ? game.i18n.localize("DICE.ROLL") + ": " + game.i18n.localize(rollName) : game.i18n.localize("DICE.ROLL"),
    ...
    static buildInputHtmlDialog(diceName, diceId, diceValue) {
        ...
        if (diceName !== "DICE.ARTIFACTS") {
            row += "<a class='modifier-button' data-operator='minus' data-field='" + diceId + "'><i class='fas fa-minus-square'></i></a>";
        }
        row += "</td>";
        row += "<td style='text-align: center;'>";
        ...
        row += "<td style='text-align: center;'>";
        if (diceName !== "DICE.ARTIFACTS") {
            row += "<a class='modifier-button' data-operator='plus' data-field='" + diceId + "'><i class='fas fa-plus-square'></i></a>";
        }
        row += "</td>";
        row += "</tr>";
        return row
