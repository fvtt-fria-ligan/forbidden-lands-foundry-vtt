function preloadHandlebarsTemplates() {
  const templatePaths = [
    "systems/forbidden-lands-rpg/chat/item.html",
    "systems/forbidden-lands-rpg/chat/roll.html",
    "systems/forbidden-lands-rpg/chat/consumable.html",
    "systems/forbidden-lands-rpg/model/character.html",
    "systems/forbidden-lands-rpg/model/monster.html",
    "systems/forbidden-lands-rpg/model/weapon.html",
    "systems/forbidden-lands-rpg/model/armor.html",
    "systems/forbidden-lands-rpg/model/monster-talent.html",
    "systems/forbidden-lands-rpg/model/monster-attack.html",
    "systems/forbidden-lands-rpg/model/gear.html",
    "systems/forbidden-lands-rpg/model/raw-material.html",
    "systems/forbidden-lands-rpg/model/talent.html",
    "systems/forbidden-lands-rpg/model/spell.html",
    "systems/forbidden-lands-rpg/model/critical-injury.html",
    "systems/forbidden-lands-rpg/model/tab/main.html",
    "systems/forbidden-lands-rpg/model/tab/combat.html",
    "systems/forbidden-lands-rpg/model/tab/combat-monster.html",
    "systems/forbidden-lands-rpg/model/tab/talent.html",
    "systems/forbidden-lands-rpg/model/tab/spell.html",
    "systems/forbidden-lands-rpg/model/tab/gear.html",
    "systems/forbidden-lands-rpg/model/tab/gear-monster.html",
    "systems/forbidden-lands-rpg/model/tab/bio.html",
    "systems/forbidden-lands-rpg/model/tab/building-stronghold.html",
    "systems/forbidden-lands-rpg/model/tab/hireling-stronghold.html",
    "systems/forbidden-lands-rpg/model/tab/gear-stronghold.html",
  ];
