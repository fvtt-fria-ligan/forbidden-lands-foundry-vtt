...
export class ForbiddenLandsStrongholdSheet extends ForbiddenLandsActorSheet {
  ...
  sendBuildingToChat(building) {
    let message =
      ...
      "</b></br>" +
      "<b>" +
      game.i18n.localize("BUILDING.REQUIREMENT") +
      ": </b>" +
      building.data.data.requirement +
      "</br>" +
      "<b>" +
      game.i18n.localize("BUILDING.RAW_MATERIALS") +
      ": </b>" +
      building.data.data.rawMaterials +
      "</br>" +
      "<b>" +
      game.i18n.localize("BUILDING.TOOLS") +
      ": </b>" +
      building.data.data.tools +
      "</br>" +
      "<b>" +
      game.i18n.localize("BUILDING.TIME") +
      ": </b>" +
      building.data.data.time +
      "</br>" +
      "<b>" +
      game.i18n.localize("BUILDING.EFFECT") +
      ": </b>" +
      building.data.data.effect +
      "</br>" +
      "<b>" +
      game.i18n.localize("BUILDING.REPUTATION") +
      ": </b>" +
      building.data.data.reputation +
      "</br>" +
      "<b>" +
      game.i18n.localize("BUILDING.NUMBER") +
      ": </b>" +
      building.data.data.number +
      "</br>" +
      "<b>" +
      game.i18n.localize("BUILDING.DESCRIPTION") +
      ": </b>" +
      building.data.data.description;
    let chatData = {
      user: game.user._id,
      content: message,
    };
  ...
  sendHirelingToChat(hireling) {
    let message =
      "<b>" +
      hireling.name.toUpperCase() +
      "</b></br>" +
      "<b>" +
      game.i18n.localize("HIRELING.SUPPLY") +
      ": </b>" +
      hireling.data.data.supply +
      "</br>" +
      "<b>" +
      game.i18n.localize("HIRELING.SALARY") +
      ": </b>" +
      hireling.data.data.salary +
      "</br>" +
      "<b>" +
      game.i18n.localize("HIRELING.NUMBER") +
      ": </b>" +
      hireling.data.data.number +
      "</br>" +
      "<b>" +
      game.i18n.localize("HIRELING.DESCRIPTION") +
      ": </b>" +
      hireling.data.data.description;
    let chatData = {
      user: game.user._id,
      content: message,
    };
