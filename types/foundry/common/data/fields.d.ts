import type * as abstract from "../abstract/module.js";
import type { TombstoneDataSchema } from "./data.js";
import type { DataModelValidationFailure } from "./validation-failure.js";
...
> {
	...
	[Symbol.iterator](): Generator<
		DataField<TSourceProp, TRequired, TNullable, THasInitial>
	>;
...
export class SetField<
	...
	TModelProp extends Set<ModelPropFromDataField<TElementField>> = Set<
...
export class EmbeddedCollectionField<
	...
	TSourceProp extends object[] = SourceFromSchema<
		TDocument["schema"]["fields"]
	>[],
	TRequired extends boolean = true,
	TNullable extends boolean = false,
	THasInitial extends boolean = true,
...
> extends NumberField<number, number, TRequired, TNullable, THasInitial> {
	protected static override get _defaults(): AngleFieldOptions<
		number,
		boolean,
		boolean,
		boolean
