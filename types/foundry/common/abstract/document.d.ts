import type * as CONST from "../constants.js";
import type { DataField, DataSchema } from "../data/fields.js";
import type * as documents from "../documents/module.js";
import type BaseUser from "../documents/user.js";
import type DataModel from "./data.js";
import type { DataModelValidationOptions } from "./data.js";
import type EmbeddedCollection from "./embedded-collection.js";
import type * as abstract from "./module.js";
...
declare global {
	type PreCreate<T extends SourceFromSchema<DataSchema>> = T extends {
		...
		? Omit<DeepPartial<T>, "_id" | "name" | "type"> & {
				_id?: Maybe<string>;
				name: string;
				type: T["type"];
		  }
	...
	interface DocumentSourceUpdateContext
		extends Omit<DocumentModificationContext<null>, "parent"> {
		dryRun?: boolean;
		fallback?: boolean;
	}
}
