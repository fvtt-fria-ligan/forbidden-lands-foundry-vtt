import type DataModel from "../abstract/data.js";
...
export class PackageCompatibility extends fields.SchemaField<PackageCompatibilitySchema> {
	constructor(
		options: fields.DataFieldOptions<
			SourceFromSchema<PackageCompatibilitySchema>,
			true,
			false,
			true
		>,
...
export class PackageRelationships extends fields.SchemaField<PackageRelationshipsSchema> {
	constructor(
		options?: fields.DataFieldOptions<
			SourceFromSchema<PackageRelationshipsSchema>,
			true,
			false,
			true
		>,
...
export class RelatedPackage extends fields.SchemaField<RelatedPackageSchema> {
	constructor(
		options?: fields.DataFieldOptions<
			SourceFromSchema<RelatedPackageSchema>,
			true,
			false,
			true
		>,
...
export default abstract class BasePackage<
	TDataSchema extends BasePackageSchema,
...
export type PackageCompendiumData =
	ModelPropsFromSchema<PackageCompendiumSchema>;
