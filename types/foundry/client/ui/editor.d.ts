...
declare global {
	...
	class TextEditor {
		...
		static enrichHTML(
			content: string | null,
			options: EnrichmentOptions & { async: false },
		): string;
		static enrichHTML(
			content: string | null,
	...
	type EditorCreateOptions = Partial<
		TinyMCE.EditorOptions | ProseMirrorEditorOptions
	> & {
