...
declare class Dialog extends Application {
	 ...
	 * @param content     The confirmation message
	 * @param options    Additional rendering options passed to the Dialog
	 * @return A promise which resolves once the user clicks the button to close the window
	 * @example
	 * let d = Dialog.prompt({
	 * title: "A Prompt Dialog",
	 * content: "<p>You can put any HTML in this dialog!</p>",
	 * });
	 * d.render(true);
	 * @example
	 * let d = Dialog.prompt({
	 * title: "Another Prompt Dialog",
	 * content: "<p>Do you want to close this dialog?</p>",
	 * label: "Close Me",
	 * callback: () => console.log("This dialog was closed!")
	 * });
	 * d.render(true);
	 * @example
	 * let d = Dialog.prompt({
	 * title: "A Third Prompt Dialog",
	 * content: "<p>Do you want to close this dialog?</p>",
	 * options: {width: 400},
	 * render: () => console.log("This dialog was rendered!")
	 * });
	 * d.render(true);
	 */
	static prompt(arg0: { title: string; content: string; options: { width: number; resizable: boolean; classes: string[]; }; render: (html: any) => void; callback: () => void; }): Dialog;
}
