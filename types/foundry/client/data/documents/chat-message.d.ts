import type { ClientBaseChatMessage } from "./client-base-mixes.js";
...
declare global {
	...
	class ChatMessage extends ClientBaseChatMessage {
		constructor(
			data: PreCreate<foundry.documents.ChatMessageSource>,
	...
	namespace ChatMessage {
		...
		function create<T extends ChatMessage>(
			...
			data: DeepPartial<
				Omit<T["_source"], "rolls"> & { rolls: (string | RollJSON)[] }
			>,
			context?: ChatMessageModificationContext,
		): Promise<T | undefined>;
		function create<T extends ChatMessage>(
