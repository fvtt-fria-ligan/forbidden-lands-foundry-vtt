 ...
 * @category - Mixins
 */
export class CanvasBaseAmbientLight<
	TParent extends ClientBaseScene | null,
...
declare class ClientBaseAmbientSound<
	TParent extends ClientBaseScene | null,
> extends foundry.documents.BaseAmbientSound<TParent> {
	protected _sheet: DocumentSheet<this> | null;
 ...
 * @category - Mixins
 */
export class CanvasBaseAmbientSound<
	TParent extends ClientBaseScene | null,
...
export class ClientBaseActor<
	TParent extends CanvasBaseToken<ClientBaseScene | null> | null,
> extends foundry.documents.BaseActor<TParent> {
	protected _sheet: DocumentSheet<
		ClientBaseActor<CanvasBaseToken<ClientBaseScene | null> | null>
	> | null;
...
export class ClientBaseActorDelta<
	TParent extends CanvasBaseToken<ClientBaseScene | null> | null,
> extends foundry.documents.BaseActorDelta<TParent> {
	protected _sheet: DocumentSheet<this> | null;
...
export class ClientBaseCard<
	TParent extends ClientBaseCards | null,
> extends foundry.documents.BaseCard<TParent> {
	protected _sheet: DocumentSheet<this> | null;
...
export class ClientBaseCombatant<
	TParent extends ClientBaseCombat | null,
> extends foundry.documents.BaseCombatant<TParent> {
	protected _sheet: DocumentSheet<this> | null;
...
declare class ClientBaseDrawing<
	TParent extends ClientBaseScene | null,
> extends foundry.documents.BaseDrawing<TParent> {
	protected _sheet: DocumentSheet<this> | null;
 ...
 * @category - Mixins
 */
export class CanvasBaseDrawing<
	TParent extends ClientBaseScene | null,
> extends ClientBaseDrawing<TParent> {
	/** A reference to the PlaceableObject instance which represents this Embedded Document. */
	_object: PlaceableObject<this> | null;
...
export class ClientBaseFogExploration extends foundry.documents
	.BaseFogExploration {
	protected _sheet: DocumentSheet<this> | null;
...
export class ClientBaseJournalEntryPage<
	TParent extends ClientBaseJournalEntry | null,
> extends foundry.documents.BaseJournalEntryPage<TParent> {
	protected _sheet: DocumentSheet<this> | null;
...
declare class ClientBaseMeasuredTemplate<
	TParent extends ClientBaseScene | null,
> extends foundry.documents.BaseMeasuredTemplate<TParent> {
	protected _sheet: DocumentSheet<this> | null;
...
declare class ClientBaseNote<
	TParent extends ClientBaseScene | null,
> extends foundry.documents.BaseNote<TParent> {
	protected _sheet: DocumentSheet<this> | null;
 ...
 * @category - Mixins
 */
export class CanvasBaseNote<
	TParent extends ClientBaseScene | null,
> extends ClientBaseNote<TParent> {
	/** A reference to the PlaceableObject instance which represents this Embedded Document. */
	_object: PlaceableObject<this> | null;
...
export class ClientBasePlaylistSound<
	TParent extends ClientBasePlaylist | null,
> extends foundry.documents.BasePlaylistSound<TParent> {
	protected _sheet: DocumentSheet<this> | null;
...
export class ClientBaseTableResult<
	TParent extends ClientBaseRollTable | null,
> extends foundry.documents.BaseTableResult<TParent> {
	protected _sheet: DocumentSheet<this> | null;
...
declare class ClientBaseTile<
	TParent extends ClientBaseScene | null,
> extends foundry.documents.BaseTile<TParent> {
	protected _sheet: DocumentSheet<this> | null;
 ...
 * @category - Mixins
 */
export class CanvasBaseTile<
	TParent extends ClientBaseScene | null,
> extends ClientBaseTile<TParent> {
	/** A reference to the PlaceableObject instance which represents this Embedded Document. */
	_object: PlaceableObject<this> | null;
...
declare class ClientBaseToken<
	TParent extends ClientBaseScene | null,
> extends foundry.documents.BaseToken<TParent> {
	protected _sheet: DocumentSheet<this> | null;
 ...
 * @category - Mixins
 */
export class CanvasBaseToken<
	TParent extends ClientBaseScene | null,
> extends ClientBaseToken<TParent> {
	/** A reference to the PlaceableObject instance which represents this Embedded Document. */
	_object: PlaceableObject<this> | null;
...
export class ClientBaseUser<
	TCharacter extends ClientBaseActor<null>,
> extends foundry.documents.BaseUser<TCharacter> {
	protected _sheet: DocumentSheet<this> | null;
...
declare class ClientBaseWall<
	TParent extends ClientBaseScene | null,
> extends foundry.documents.BaseWall<TParent> {
	protected _sheet: DocumentSheet<this> | null;
 ...
 * @category - Mixins
 */
export class CanvasBaseWall<
	TParent extends ClientBaseScene | null,
> extends ClientBaseWall<TParent> {
	/** A reference to the PlaceableObject instance which represents this Embedded Document. */
	_object: PlaceableObject<this> | null;
