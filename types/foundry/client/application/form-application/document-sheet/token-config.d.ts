...
> extends DocumentSheet<TDocument, TOptions> {
	...
	protected _getAlternateTokenImages(): Promise<
		Record<string, ImageFilePath | VideoFilePath>
	>;
	 ...
	 * @param modes The existing detection modes.
	 */
	protected _onRemoveDetectionMode(
		index: number,
		modes: TokenDetectionMode[],
	): void;
}
