...
export class ForbiddenLandsCharacterGenerator extends Application {
    ...
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            ...
            template: "modules/forbidden-lands-character-generator/templates/character-generator.html",
    ...
    static async loadDataset() {
        const datasetDir = game.settings.get("forbidden-lands-character-generator", "datasetDir");
        const resp = await fetch(datasetDir + '/dataset.json').catch(err => { return {} });
        return resp.json();
    }
    ...
    async handleCreateActor() {
        ...
        let actor = await Actor.create(coverter.convert(this.character));
    ...
    setKin(character, kinKey) {
        ...
        if (character.age === undefined) {
            ...
            character.age.ageNumber = this.rollNumber(kin.age[character.age.ageKey][0], kin.age[character.age.ageKey][1]);
        }
